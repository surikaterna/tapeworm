...
EventStorePartition.prototype.append = function (commits, callback, correlationId) {
  //pre hooks
  var self = this;
  ...
  return Promise.each(commits, function (commit) {
    return self._persistencePartition.append(commit, callback, correlationId).then(function (r) {
      var done = function () {
