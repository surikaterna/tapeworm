...
EventStream.prototype.commit = function (commitId, callback, correlationId) {
  var self = this;
  ...
  if (!this.hasChanges()) {
    ...
    var commit = this._buildCommit(commitId, this._uncommittedEvents, correlationId);
...
EventStream.prototype._buildCommit = function (commitId, events, correlationId) {
  var commitSequence = this._commitSequence;
  var commit = new Commit(commitId, this._partition._partitionId, this._streamId, ++commitSequence, events, correlationId);
