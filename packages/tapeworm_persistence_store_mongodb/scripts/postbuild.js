...
//
// Without this, `require('tapeworm_persistence_store_mongodb')` returns
// `{ default: MongoDBPersistence, ... }` instead of the constructor directly.
// The shim restores the legacy behavior:
//   `const MongoDBPersistence = require('tapeworm_persistence_store_mongodb')`
//
